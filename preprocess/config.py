...
RESNET_LARGE_PROTOTXT_PATH = PREFIX + "/vqa_mcb/preprocess/ResNet-152-448-deploy.prototxt"
RESNET_PROTOTXT_PATH = PREFIX + "/vqa_mcb/preprocess/ResNet-152-deploy.prototxt"
RESNET_MEAN_PATH = PREFIX + "/vqa_mcb/preprocess/ResNet_mean.binaryproto"
